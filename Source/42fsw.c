...
void SlugSatFSW(struct SCType *S)
{
	...
	// Find power generated by the solar panels
	genPower += 2*(AC->CSS[0].Illum*panelPower + AC->CSS[1].Illum*panelPower + AC->CSS[2].Illum*panelPower + AC->CSS[3].Illum*panelPower);
	genPower += AC->CSS[4].Illum*panelPower;
	...
	printf("\nReaction Wheel Power:\t%7.3f [mW]\n", 1000*rwPower);
	printf("Torque Rod Power:\t%7.3f [mW]\n", 1000*trPower);
	printf("Total Power:\t\t%7.3f [mW]\n", 1000*totalPower);
	printf("Generated Power:\t%7.3f [mW]\n", 1000*genPower);
	...
	cumulative_gen_power += genPower*AC->DT;
