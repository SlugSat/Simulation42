...
void SunReport(void)
{
      ...
      fprintf(sunfile,"%le %le %le \n", 
    	 SC[0].AC.svb[0], SC[0].AC.svb[1], SC[0].AC.svb[2]);
...
void MagReport(void)
{
      static FILE *magfile1;
     // static FILE *magfile2; 
	 // static FILE *magfile3;
      static long First = 1;
